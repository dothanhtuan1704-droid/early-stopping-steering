...
Linear Decay ($K{=}16$) & 67.80 & 0.6732 & 99.80 & 5.37 & $0.1189$ & $[-0.20, +5.20]$ \\
...
\textbf{Temporal Window Injection Shift Control.} Intervening early ($t \in [1, 16]$) under constant step injection ($\alpha_0=18.0$) achieves 5.24\% Rep-4 at 800 tokens (2.17\% at 200 tokens), whereas applying the Linear Decay schedule ($K=16$) yields 5.37\% at 800 tokens (3.74\% at 200 tokens). Delayed step injection ($t \in [17, 32]$) elevates repetition to 5.56\% (800 tokens) / 2.19\% (200 tokens), and later injection ($t \in [33, 48]$) drops RefPref to 72.80\% (baseline 73.00\%), confirming that early intervention is critical to shape initial semantic trajectory commitment.
...
print('Updated paper_soict.tex with all 10 feedback fixes successfully!')
