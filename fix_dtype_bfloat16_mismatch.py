...
nb6_cells = [
    ...
    ('code', '# Cell 3: Multi-GPU and BFloat16/Float16 Safe Teacher Forcing Activation Tracker Hook\n'
...
print("[SUCCESS] Notebook 06 upgraded with BFloat16/Float16 dtype alignment and float32 dot product safety!")
