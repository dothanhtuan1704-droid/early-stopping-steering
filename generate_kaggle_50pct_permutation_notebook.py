"""
Fixes multi-GPU device_map='auto' (cuda:0 vs cuda:1) in kaggle_exp09_full_50pct_label_permutation.ipynb hook_fn.
Dynamically maps v_vector to output_tensor.device on whichever GPU the layer executes.
"""
import json
...
with open("kaggle_exp09_full_50pct_label_permutation.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook_content, f, indent=2)

print("Fixed multi-GPU device_map in kaggle_exp09_full_50pct_label_permutation.ipynb successfully!")
