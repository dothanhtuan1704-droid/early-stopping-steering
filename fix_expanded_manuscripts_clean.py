...
# Build New Sections V-E and V-F
new_sections = r'''
...
if target_marker in tex:
    new_tex = tex.replace(target_marker, new_sections + '\n\n' + target_marker)
else:
    target_marker = r'\section{Discussion}'
    new_tex = tex.replace(target_marker, new_sections + '\n\n' + target_marker)

# Add BGE-M3 reference to bibliography if missing
...
print("[SUCCESS] Successfully inserted new sections BEFORE Discussion & Limitations and BEFORE \\end{document}!")
