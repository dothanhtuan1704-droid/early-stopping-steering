...
\end{equation}
Layer-wise linear probing on the validation split ($N_{\text{val}}=2,223$) identified module block $j^*=8$ (the 9th residual block of Qwen2.5-7B, $d=3,584$) as exhibiting peak separation, selected as the frozen intervention layer.
