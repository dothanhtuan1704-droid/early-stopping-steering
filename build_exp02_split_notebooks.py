...
def create_exp02_notebook(part_num, part_name, window_start, window_end, output_json, filename):
    cells = [
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
                f"# 🔬 Experiment 2 - Part {part_num}: Delayed Injection Window Control ({part_name}) [200 tokens]\n",
                f"**Mục tiêu:** Đánh giá can thiệp steering cửa sổ **{part_name}** (`window_start={window_start}`, `window_end={window_end}`) với $\\alpha_0=18.0$ ở độ dài `max_new_tokens=200` trên 500 mẫu Test.\n",
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "# Cell 6: Thực Thi Sinh 500 Câu với Hook Can Thiệp Cửa Sổ\n",
                ...
                "gen_lengths = []\n",
                "\n",
                "print(f'🚀 Starting Generation for {len(test_records)} prompts...')\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "final_summary = {\n",
                "    \"experiment\": f\"Exp02_Part{PART_NUM}_{PART_NAME}\",\n",
...
create_exp02_notebook(1, "Early_1_16", 1, 16, "exp02_part1_early_results.json", "Exp02_Part1_Early_1_16_200tok.ipynb")
create_exp02_notebook(2, "Delayed_17_32", 17, 32, "exp02_part2_delayed_results.json", "Exp02_Part2_Delayed_17_32_200tok.ipynb")
create_exp02_notebook(3, "Later_33_48", 33, 48, "exp02_part3_later_results.json", "Exp02_Part3_Later_33_48_200tok.ipynb")
create_exp02_notebook(4, "Continuous", 1, 9999, "exp02_part4_continuous_results.json", "Exp02_Part4_Continuous_200tok.ipynb")

print("\nALL 4 FIXED EXP02 NOTEBOOKS CREATED SUCCESSFULLY!")
