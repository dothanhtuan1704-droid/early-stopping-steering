...
def create_exp02_800tok_notebook(part_num, part_name, window_start, window_end, output_json, filename):
    cells = [
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
                f"# 🔬 Experiment 2 - Part {part_num}: Delayed Injection Window Control ({part_name}) [800 tokens]\n",
                f"**Mục tiêu:** Đánh giá can thiệp steering cửa sổ **{part_name}** (`window_start={window_start}`, `window_end={window_end}`) với $\\alpha_0=18.0$ ở độ dài `max_new_tokens=800` (Natural Completion) trên 500 mẫu Test.\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "refs_pos = [item['pos_ref'] for item in test_records]\n",
                "refs_neg = [item['neg_ref'] for item in test_records]\n",
                "\n",
    ...
    print(f"Created 800tok notebook: {filename}")

create_exp02_800tok_notebook(1, "Early_1_16", 1, 16, "exp02_part1_early_800tok_results.json", "Exp02_Part1_Early_1_16_800tok.ipynb")
create_exp02_800tok_notebook(2, "Delayed_17_32", 17, 32, "exp02_part2_delayed_800tok_results.json", "Exp02_Part2_Delayed_17_32_800tok.ipynb")
create_exp02_800tok_notebook(3, "Later_33_48", 33, 48, "exp02_part3_later_800tok_results.json", "Exp02_Part3_Later_33_48_800tok.ipynb")
create_exp02_800tok_notebook(4, "Continuous", 1, 9999, "exp02_part4_continuous_800tok_results.json", "Exp02_Part4_Continuous_800tok.ipynb")

print("\nALL 4 EXP02 800TOK NOTEBOOKS CREATED SUCCESSFULLY!")
