...
# ==============================================================================
# NOTEBOOK 06: FULL TEACHER FORCING ACTIVATION TRAJECTORY PROBING
# ==============================================================================
nb6_cells = [
    ...
    ('code', '# Cell 3: Load Steering Vector & Define PyTorch Forward Hook Class\n'
             ...
             '            t = self.current_step\n'
             '            \n'
             '            # Compute schedule coefficient alpha(t)\n'
    ...
    ('code', '# Cell 4: Load Medical Test Prompts & Execute Teacher Forcing Loop\n'
             ...
             '    dataset = json.load(f)\n'
             '\n'
             'test_prompts = dataset[:50] # Evaluate across N_test=50 prompts\n'
             'print(f"[*] Loaded {len(test_prompts)} prompts for fixed-token teacher forcing.")\n'
             '\n'
             '# Dummy / Extracted 3584-dim Steering Vector\n'
             ...
             '        })\n'
             '\n'
             'print("[+] Execution loop finished! Total runs:", len(all_results))\n'),
...
# ==============================================================================
# NOTEBOOK 07: FULL DENSE & HYBRID RAG EVALUATION WITH PROFILING
# ==============================================================================
nb7_cells = [
    ...
    ('code', '# Cell 2: Load Drug Formulary Passages & Test Benchmark Questions\n'
             ...
             'test_items = dataset[:500] # N_test=500 question-disjoint evaluation subset\n'
...
print("[SUCCESS] Both complete Jupyter Notebooks generated and verified!")
