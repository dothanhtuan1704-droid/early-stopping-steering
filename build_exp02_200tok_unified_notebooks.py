...
def create_exp02_200tok_unified_notebook(part_num, part_name, window_start, window_end, output_json, filename):
    cells = [
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
                f"# 🔬 Experiment 2 - Part {part_num}: Delayed Injection Window Control ({part_name}) [500 samples, 200tok]\n",
                f"**Mục tiêu:** Đánh giá can thiệp steering cửa sổ **{part_name}** (`window_start={window_start}`, `window_end={window_end}`) với $\\alpha_0=18.0$ ở độ dài `max_new_tokens=200` trên trọn vẹn 500 mẫu Test.\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "gen_lengths = []\n",
                "\n",
                "print(f'🚀 Starting 200-token Generation for {len(test_records)} prompts...')\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "final_summary = {\n",
                "    \"experiment\": f\"Exp02_Part{PART_NUM}_{PART_NAME}_200tok\",\n",
    ...
    print(f"Created 200tok unified 500-sample notebook: {filename}")
...
for part_num, name, start, end in windows:
    create_exp02_200tok_unified_notebook(
        part_num, name, start, end,
        f"exp02_part{part_num}_{name.lower()}_200tok_results.json",
        f"Exp02_Part{part_num}_{name}_200tok.ipynb"
    )

print("\nALL 4 UNIFIED 200TOK NOTEBOOKS CREATED SUCCESSFULLY!")
